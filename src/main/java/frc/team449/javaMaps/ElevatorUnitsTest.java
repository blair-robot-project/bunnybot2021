...
public class ElevatorUnitsTest {
        ...
        var elevator =
                new OneMotorPulleyElevator(
                        ...
                        new TrapezoidProfile.Constraints(
                                elevatorMaxVelocity, elevatorMaxAccel)); // TODO [IMPORTANT] These values are placeholders
    ...
    */
        ...
        var resetElevatorSetpointCommand = new InstantCommand(()-> elevatorPulleyMotor.setPositionSetpoint(elevatorPulleyMotor.getPositionUnits()),elevator);
        var buttons =
                List.of(
